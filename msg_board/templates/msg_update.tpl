...
<div class="board-page">
    <div class="input-area">
        ...
        <input type ="text" name="title" value="{$title}" maxlength="50"><br><br>

        內容 : <font size = "1" color = "gray">(最多輸入5000個字元)</font><br>
        <textarea type ="text" name="content"  style="width:300px; height:200px;" style="vertical-align:text-top;" maxlength="5000">{$content}</textarea><br><br>
