				...
				<div class="col-sm-4">
					...
					<div class="signup-form"><!--sign up form-->
						...
						<form action="{{$script.rp}}" method="post">
							<input type="varchar" name="account" placeholder="Account" maxlength="25" required />
							<input type="password" name="password" placeholder="Password" maxlength="20" required />
							<input type="varchar" name="name" placeholder="Name" maxlength="20" required />
							<input type="varchar" name="phone" placeholder="Phone" maxlength="11" required />
							<input type="email" name="email" placeholder="Email Address" maxlength="50" required />
							<!-- 重新產生驗證碼 -->
							<script>
